...
namespace TL.Api.Web.Formats
{
    [JsonObject]
    public class JsonApiResponseFormat : __BaseApiObject__
    {
        protected override string ObjectDescription => "Объект формата JSON ответа";
