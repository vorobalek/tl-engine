...
{
    public class CheckController : __TestBaseApiController__
    {
        public override string Command => "test.Check";
        ...
        public IActionResult Get() => Ok(GetJson(ok: true, result: "Check HTTP GET"));
        ...
        public IActionResult Get(int id) => 
            Ok(GetJson(ok: true, result: new { report = $"Check HTTP GET whith Id = {id}" }));
        ...
        public IActionResult Post([FromQuery] string data) =>
            Ok(GetJson(ok: true, result: new { report = $"Check HTTP POST", data }));
        ...
        public IActionResult Post(int id, [FromQuery] string data) => 
            Ok(GetJson(ok: true, result: new { report = $"Check HTTP POST whith Id = {id}", data }));
        ...
        public IActionResult Put([FromQuery] string data) =>
            Ok(GetJson(ok: true, result: new { report = $"Check HTTP PUT", data }));
        ...
        public IActionResult Put(int id, [FromQuery] string data) =>
            Ok(GetJson(ok: true, result: new { report = $"Check HTTP PUT whith Id = {id}", data }));
        ...
        public IActionResult Delete([FromQuery] string id) =>
           Ok(GetJson(ok: true, result: new { report = $"Check HTTP DELETE whith Id = {id}" }));
